...
def build_image_prompt(product: str, description: str, headline: str) -> str:
    return (
        ...
        "Use the ACE Shape-First Hybrid Engine.\n\n"
        ...
        "FULL OBJECTS AND CLASSIC NATURAL BACKGROUND OF A:\n"
        "- Never crop A or B at the frame edges.\n"
        "- Each object must appear as a complete object, fully inside the image boundaries.\n"
        "- Object A has its CLASSIC NATURAL BACKGROUND: the real-life environment where A is typically found\n"
        "  (for example: classroom, kitchen, bathroom, office, grass field, road, workshop, studio, shelf, etc.).\n"
        "- Build the hybrid scene as follows:\n"
        "  1) Use the classic natural background of object A (its familiar real-world environment).\n"
        "  2) Remove A as a visible object.\n"
        "  3) Place object B as a complete, intact object inside A's background.\n"
        "- The background must stay recognizable as A's world.\n"
        "- Do NOT use abstract backgrounds, gradients, random studio voids, or invented places.\n"
