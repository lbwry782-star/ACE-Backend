...
def generate():
    ...
    if not dev_mode:
        ...
        # Mark as used right away (even if generation later fails)
    ...
    text_prompt = (
        ...
        "Create 3 different short English ad headlines and 3 short English marketing texts.\n"
        "Rules:\n"
        "- Headlines: 3–7 words, punchy, related to the product and to a clear, simple visual metaphor.\n"
        "- Marketing texts: 1–2 short sentences each.\n"
    ...
    def build_image_prompt(headline: str) -> str:
        base = (
            ...
            "Leave comfortable empty space around the main objects for a hypothetical headline.\n"
